function [phone_dist, times] = calc_phone_distribution(window_length, feature_vec, phones, phone_features, time_vec)
...
if num_obs > window_length
    ...
    for w = 1:num_windows
        ...
        this_phone_dist = calc_phone_distribution(window_length, this_feature_vec, phones, phone_features);
