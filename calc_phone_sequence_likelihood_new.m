function results = calc_phone_sequence_likelihood_new(likelihood, phone_sequence, transition_sequence, duration_distn, tsylb_option, method)
...
results = struct('likelihood', likelihood, 'phoneme_evidence', phoneme_evidence, 'expected_durations', expected_durations, 'duration_prob', duration_prob);
