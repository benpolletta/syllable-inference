function [sentence, likelihood, posterior] = plotSLPP
...
for_plot(3).time = likelihood.time;
for_plot(3).input_vec = nanunitsum(posterior.phone_prior);
for_plot(3).feature_names = likelihood.phones;

subplot(4, 1, 4)

plotSentence(gca, for_plot(3))
